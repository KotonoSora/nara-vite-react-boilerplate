...
export default function SecureProfile({
  ...
  const message = (actionData as any)?.message as string | undefined;
          ...
          <div className="px-4 py-5 sm:p-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-orange-700">
                    <p>
                      This area requires additional basic authentication for
                      enhanced security.
                    </p>
                  </div>
                </div>
            ...
            <div className="mb-6">
              ...
              <p className="mt-2 text-gray-600">
                Manage sensitive profile information and API tokens with
                enhanced security.
              </p>
            </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <dl className="space-y-2">
                  ...
                  <div>
                    ...
                    <dd className="text-sm text-orange-600 font-semibold uppercase">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Manage your API tokens for programmatic access. These tokens
                provide secure access to your account via API.
              </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>
                      This page requires high-security authentication. You have
                      been authenticated using:
                    </p>
