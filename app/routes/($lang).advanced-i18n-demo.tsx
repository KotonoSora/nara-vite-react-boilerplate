...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Comprehensive demonstration of advanced i18n features",
    },
  ];
}
...
export default function AdvancedI18nDemo() {
  ...
  const [contextualTranslations, setContextualTranslations] = useState<
  ...
  useEffect(() => {
    if (advancedTranslation.isReady) {
      ...
      const translations = {
        greeting: advancedTranslation.translateWithContext(
          "admin.roleBasedAccess.accessGranted.message",
        ),
        welcome: advancedTranslation.translateWithContext("admin.title"),
        itemCount: advancedTranslation.translateWithContext("navigation.home"),
      };
  ...
  const handleContextChange = useCallback(
    (newContext: Partial<typeof translationContext>) => {
  ...
  const colorAppropriate = cultural.checkColorAppropriate(
    "#FF0000",
    "celebration",
  );
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-8">
        ...
        <div className="text-center bg-white rounded-xl shadow-lg p-8">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Experience the next-generation i18n features with cultural
            adaptation, accessibility, performance optimization, and advanced
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleContextChange({ audience: e.target.value as any })
                      }
                      className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleContextChange({ purpose: e.target.value as any })
                      }
                      className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                    >
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                  <div>
                    ...
                    <span className="ml-2 text-blue-600">
                      {contextualTranslations.greeting}
                    </span>
                  </div>
                  <div>
                    <span className="font-medium">Welcome:</span>
                    <span className="ml-2 text-blue-600">
                      {contextualTranslations.welcome}
                    </span>
                  </div>
                  <div>
                    <span className="font-medium">Item Count:</span>
                    <span className="ml-2 text-blue-600">
                      {contextualTranslations.itemCount}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                {advancedTranslation.isReady && (
                  <ValidationResults
                    validation={advancedTranslation.validateTranslations(
                      language,
                    )}
                  />
                )}
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <button
                    onClick={() => {
                      const data =
                        advancedTranslation.exportTranslations("json");
                      if (data) {
                        downloadFile(
                          data,
                  ...
                  <button
                    onClick={() => {
                      const data =
                        advancedTranslation.exportTranslations("csv");
                      if (data) {
                        downloadFile(
                          data,
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 text-sm space-y-2">
                  <div>
                    ...
                    <span
                      className={`ml-2 ${advancedTranslation.isReady ? "text-green-600" : "text-red-600"}`}
                    >
                      {advancedTranslation.isReady
                        ? "Ready"
                        : "Initializing..."}
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-purple-600">
                      {Object.entries(translationContext)
                        .map(([k, v]) => `${k}:${v}`)
                        .join(", ")}
                    </span>
                  </div>
            ...
            <div className="space-y-4">
              ...
              {detection.detectionResult && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-green-700">
                    Method: {detection.detectionResult.method}
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <p>
                    ...
                    {cultural.formatName(sampleName, { formal: true })}
                  </p>
                  <p>
                    <strong>Casual:</strong> {cultural.formatName(sampleName)}
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <p>
                    <strong>Local:</strong> {cultural.formatPhone("1234567890")}
                  </p>
                  <p>
                    <strong>International:</strong>{" "}
                    {cultural.formatPhone("1234567890", {
                      international: true,
                    })}
                  </p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-1 text-sm">
                  <p>
                    <kbd className="bg-gray-200 px-2 py-1 rounded">Alt+L</kbd> -
                    Language Switcher
                  </p>
                  <p>
                    <kbd className="bg-gray-200 px-2 py-1 rounded">Alt+H</kbd> -
                    Home
                  </p>
                  <p>
                    <kbd className="bg-gray-200 px-2 py-1 rounded">Alt+S</kbd> -
                    Search
                  </p>
                  <p>
              ...
              <div>
                ...
                <button
                  onClick={() =>
                    accessibility.announceLanguageChange(language, true)
                  }
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono">
                      {(performanceData.memoryUsage / 1024).toFixed(1)} KB
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Load Time:</span>
                    <span className="font-mono">
                      {performanceData.loadTime.toFixed(1)}ms
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Missing Translations:</span>
                    <span className="font-mono">
                      {performanceData.translationMisses}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  {Array.from(performance.getLanguageAnalytics().entries())
                    .slice(0, 3)
                    .map(([lang, stats]) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {advanced.preferences.current ? (
                  <>
                    <p>
                      ...
                      {advanced.preferences.current.primaryLanguage}
                    </p>
                    <p>
                      <strong>Fallbacks:</strong>{" "}
                      {advanced.preferences.current.fallbackLanguages.join(
                        ", ",
                      )}
                    </p>
                    <p>
                      <strong>Method:</strong>{" "}
                      {advanced.preferences.current.detectionMethod}
                    </p>
                    <p>
                      <strong>Last Used:</strong>{" "}
                      {new Date(
                        advanced.preferences.current.lastUsed,
                      ).toLocaleString()}
                    </p>
                  </>
                ) : (
            ...
            <div>
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    advanced.preferences.save({ detectionMethod: "manual" })
                  }
        ...
        {process.env.NODE_ENV === "development" && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
            ...
            <div className="bg-yellow-100 rounded-lg p-4 font-mono text-sm text-yellow-900 space-y-1">
              ...
              <p>
                naraI18nDev.setContext(&#123;formality: "formal"&#125;) - Set
                translation context
              </p>
...
function ValidationResults({
  ...
  const hasIssues =
    missing.length > 0 || incomplete.length > 0 || warnings.length > 0;
      ...
      {incomplete.length > 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          ...
          <ul className="text-yellow-700 text-xs mt-1 ml-4 list-disc">
            {incomplete.slice(0, 3).map((key) => (
              <li key={key}>{key}</li>
            ))}
            {incomplete.length > 3 && (
              <li>...and {incomplete.length - 3} more</li>
            )}
          </ul>
        </div>
      )}
