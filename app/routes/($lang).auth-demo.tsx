...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Authentication Demo - NARA" },
    {
      name: "description",
      content:
        "Demonstration of enhanced authentication and authorization features",
    },
  ];
}

export default function AuthDemo({ loaderData }: Route.ComponentProps) {
  const { isAuthenticated, user, oauthAccounts, permissions, apiTokens } =
    loaderData;
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Experience the comprehensive authentication features of NARA
              Boilerplate
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>
                    • <strong>Password Hashing:</strong> bcrypt with 12 salt
                    rounds
                  </li>
                  <li>
                    • <strong>Session Management:</strong> Secure HTTP-only
                    cookies
                  </li>
                  <li>
                    • <strong>API Authentication:</strong> JWT tokens with
                    HMAC-SHA256
                  </li>
                  <li>
                    • <strong>OAuth 2.0:</strong> Google & GitHub integration
                  </li>
                  <li>
                    • <strong>Rate Limiting:</strong> Sliding window with SQLite
                    backend
                  </li>
                  <li>
                    • <strong>CSRF Protection:</strong> State parameter
                    validation
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>
                    • <strong>RBAC:</strong> Role-based access control system
                  </li>
                  <li>
                    • <strong>Permissions:</strong> Fine-grained resource.action
                    pairs
                  </li>
                  <li>
                    • <strong>Inheritance:</strong> Role permissions + user
                    overrides
                  </li>
                  <li>
                    • <strong>API Scopes:</strong> Token-based access control
                  </li>
                  <li>
                    • <strong>Audit Trail:</strong> Login attempts and access
                    logs
                  </li>
                  <li>
