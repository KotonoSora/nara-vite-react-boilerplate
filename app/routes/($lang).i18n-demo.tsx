...
import { useFormatting, useI18n, usePluralization } from "~/lib/i18n";
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Experience advanced i18n features with formatting and
              pluralization
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div>
                    <label className="block text-sm text-gray-500">
                      Local Currency: {sampleNumber}
                    </label>
                    <p className="text-lg font-mono">
                      {formatCurrency(sampleNumber)}
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm text-gray-500">
                    ...
                    <p className="text-lg font-mono">
                      {formatCurrency(sampleNumber, "USD")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {[0, 1, 2, 5, 11, 100].map((count) => (
                <div key={count} className="space-y-2">
                  ...
                  <div className="space-y-1 text-sm">
                    <p>
                      <strong>Items:</strong> {plural("items", count)}
                    </p>
                    <p>
                      <strong>Users:</strong> {plural("users", count)}
                    </p>
                    <p>
                      <strong>Comments:</strong> {plural("comments", count)}
                    </p>
                    <p>
                      <strong>Days:</strong> {plural("days", count)}
                    </p>
                  </div>
                </div>
              ))}
