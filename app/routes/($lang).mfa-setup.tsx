...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Set up two-factor authentication for enhanced security",
    },
  ];
}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  MFA is currently{" "}
                  {mfaStatus.isEnabled ? "enabled" : "disabled"} for your
                  account
                </p>
              </div>
              <div
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Disabling MFA will make your account less secure. You'll need to enter
