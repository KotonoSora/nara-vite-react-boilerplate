...
export async function action({ request, context, params }: Route.ActionArgs) {
  ...
  try {
    ...
    await logSecurityAccess(db, newAdmin.id, request, "/admin-register", "critical", {
    ...
    const redirectPath = language === DEFAULT_LANGUAGE ? "/login" : `/${language}/login`;
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            {t.admin?.registerSubtitle || "Create a new administrator account"}
          </p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  <strong>Restricted Access:</strong> This page requires a valid admin secret key.
        ...
        <Form className="mt-8 space-y-6" method="post">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  placeholder={t.admin?.secretPlaceholder || "Enter admin secret key"}
                />
                <button
                  type="button"
          ...
          <div className="text-center">
            <a
              href={language === DEFAULT_LANGUAGE ? "/login" : `/${language}/login`}
