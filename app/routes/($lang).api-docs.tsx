...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Complete API documentation for authentication workflows" },
  ];
}
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg border">
                  ...
                  <p className="text-gray-700 mb-3">
                    Basic authentication using sessions (UI) or JWT tokens (API).
                  </p>
                ...
                <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-500">
                  ...
                  <p className="text-orange-800 mb-3">
                    Enhanced security with additional basic authentication layer.
                  </p>
                  <div className="text-sm text-orange-700">
                    <strong>Requirements:</strong> Session/JWT + Basic Auth + Permissions
                  </div>
                </div>
                ...
                <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
                  ...
                  <div className="text-sm text-red-700">
                    <strong>Requirements:</strong> Session/JWT + Basic Auth + Admin Permissions + Audit Logging
                  </div>
                </div>
              </div>
            </div>
...
{`{
  ...
  "user": {
    ...
    "role": "user"
                ...
                <div className="bg-white border rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">Verify Token</h3>
                    <span className="bg-green-100 text-green-800 px-3 py-1 rounded text-sm font-medium">POST</span>
                  </div>
                  <code className="bg-gray-100 px-3 py-1 rounded text-sm block mb-4">
                    /api/auth/verify
...
{`{
  ...
  "scopes": ["profile:read", "api:access"]
                ...
                <div className="bg-white border rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">Get Current User</h3>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      All API endpoints are rate limited. Check the response headers for limit information:
                    </p>
