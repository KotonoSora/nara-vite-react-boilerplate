...
export function createEmailVerificationTemplate(data: EmailVerificationData): EmailOptions {
...
export function createPasswordResetTemplate(data: PasswordResetData): EmailOptions {
