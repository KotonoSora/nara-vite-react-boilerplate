...
export function getRelativeTimeString(
  ...
  if (absSeconds < 60) {
    ...
    return formatRelativeTime(Math.floor(diffInSeconds / 60), 'minute', language);
  } else if (absSeconds < 86400) {
    return formatRelativeTime(Math.floor(diffInSeconds / 3600), 'hour', language);
  } else if (absSeconds < 2592000) {
    return formatRelativeTime(Math.floor(diffInSeconds / 86400), 'day', language);
  } else if (absSeconds < 31536000) {
    return formatRelativeTime(Math.floor(diffInSeconds / 2592000), 'month', language);
  } else {
    return formatRelativeTime(Math.floor(diffInSeconds / 31536000), 'year', language);
  }
}
