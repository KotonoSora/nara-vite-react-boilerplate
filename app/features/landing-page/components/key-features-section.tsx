...
export function KeyFeaturesSection() {
  ...
  return (
    <section className="py-24 px-4 bg-background relative overflow-hidden content-visibility-auto">
      ...
      <div
        className="absolute inset-0 bg-linear-to-br from-primary/5 via-transparent to-green-500/5"
        aria-hidden="true"
      />
      <div
      ...
      <div className="container mx-auto relative">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/10 to-green-500/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-6">
