/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0ba13566190b04af99e167194059f4b)
// Runtime types generated with workerd@1.20251011.0 2025-04-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
	}
	interface Env {
		VITE_MAX_USERS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_MAX_USERS" | "VITE_LANDING_PAGE_TITLE" | "VITE_LANDING_PAGE_DESCRIPTION" | "VITE_LANDING_PAGE_REPOSITORY" | "VITE_LANDING_PAGE_COMMERCIAL_LINK" | "VITE_CONTACT_EMAIL">> {}
}
